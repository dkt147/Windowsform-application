...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string CustomerId, string CompanyName, string ContactName, string ContactTitle) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow FindByCustomerId(string CustomerId) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string ContactTitle {
                get {
                    try {
                        return ((string)(this[this.tableTable.ContactTitleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ContactTitle\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.ContactTitleColumn] = value;
                }
            }
            ...
            public bool IsContactTitleNull() {
                return this.IsNull(this.tableTable.ContactTitleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetContactTitleNull() {
                this[this.tableTable.ContactTitleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApp1.Database1DataSet4TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_CompanyName = 1 AND [CompanyName] IS NULL) OR ([CompanyName] = @Original_CompanyName)) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([CustomerId], [CompanyName], [ContactName], [ContactTitle]) VALUES (@CustomerId, @CompanyName, @ContactName, @ContactTitle);
SELECT CustomerId, CompanyName, ContactName, ContactTitle FROM [Table] WHERE (CustomerId = @CustomerId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [CustomerId] = @CustomerId, [CompanyName] = @CompanyName, [ContactName] = @ContactName, [ContactTitle] = @ContactTitle WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_CompanyName = 1 AND [CompanyName] IS NULL) OR ([CompanyName] = @Original_CompanyName)) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)));
SELECT CustomerId, CompanyName, ContactName, ContactTitle FROM [Table] WHERE (CustomerId = @CustomerId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CompanyName, ContactName, ContactTitle FROM dbo.[Table]";
        ...
        public virtual int Fill(Database1DataSet4.TableDataTable dataTable) {
        ...
        public virtual Database1DataSet4.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet4.TableDataTable dataTable = new Database1DataSet4.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet4.TableDataTable dataTable) {
        ...
        public virtual int Insert(string CustomerId, string CompanyName, string ContactName, string ContactTitle) {
            if ((CustomerId == null)) {
        ...
        public virtual int Update(string CustomerId, string CompanyName, string ContactName, string ContactTitle, string Original_CustomerId, string Original_CompanyName, string Original_ContactName, string Original_ContactTitle) {
            if ((CustomerId == null)) {
                throw new global::System.ArgumentNullException("CustomerId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CompanyName, string ContactName, string ContactTitle, string Original_CustomerId, string Original_CompanyName, string Original_ContactName, string Original_ContactTitle) {
            return this.Update(Original_CustomerId, CompanyName, ContactName, ContactTitle, Original_CustomerId, Original_CompanyName, Original_ContactName, Original_ContactTitle);
        }
    }
